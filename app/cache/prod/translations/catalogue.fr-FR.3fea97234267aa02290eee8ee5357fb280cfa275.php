...
$catalogue = new MessageCatalogue('fr-FR', array (
  ...
  array (
    ...
    'Delete selected items?' => 'Supprimer la sélection ?',
    'Enable' => 'Activer',
    'Sort by' => 'Tri',
    ...
    'Preview' => 'Visualiser',
    'Create' => 'Créer',
    'Check / Uncheck all' => 'Tout sélectionner / désélectionner',
    'Select' => 'Choisir',
  ...
  array (
    ...
    'URL rewriting failed to auto-generate a friendly URL for: %s' => 'La réécriture d\'URL automatique n\'est pas parvenue à générer une URL simplifiée pour : %s',
...
<br />- Donner les droits d\'écriture du fichier créé (CHMOD 666 sur les systèmes Unix).',
  ...
  array (
    ...
    'Customer service options' => 'Options du service client',
    'IMAP URL' => 'URL IMAP',
    'IMAP port' => 'Port IMAP',
  ...
  array (
    ...
    'Enable or disable the product on your shop: ALT+SHIFT+0' => 'Activer ou désactiver le produit sur votre boutique : ALT+MAJ+O',
  ...
  array (
    ...
    'Automatic (longest side)' => 'Automatique (plus grand côté)',
  ...
  array (
    ...
    'The following module(s) were not upgraded successfully: %s.' => 'La mise à jour ne s\'est pas faite correctement pour le(s) module(s) suivant(s) : %s.',
  ...
  array (
    ...
    'An error occurred while updating the status for an object.' => 'Une erreur s\'est produite pendant la mise à jour de l\'état de l\'objet.',
    'You do not have permission to view this.' => 'Vous n\'avez pas la permission de voir ce contenu.',
    'You do not have permission to delete this.' => 'Vous n\'avez pas la permission de supprimer ce contenu.',
    ...
    'You cannot upload more files' => 'Vous ne pouvez pas mettre en ligne plus de fichiers',
...
Cordialement,',
    ...
    'Awaiting check payment' => 'En attente de paiement par chèque',
    ...
    'Group access' => 'Accès des groupes',
    'Default customer group' => 'Groupe par défaut',
    'SIRET' => 'SIRET',
    'APE' => 'APE',
    'Website' => 'Site web',
  ...
  array (
    ...
    'Format: 2011-12-31 (inclusive).' => 'Au format 2012-02-20 (inclusif).',
    'Format: 2012-12-31 (inclusive).' => 'Au format 2012-04-21 (inclusif).',
  ...
  array (
    ...
    'Invalid new order status' => 'Statut de commande invalide',
    ...
    'This customer does not exist.' => 'Cet identifiant client n\'est pas reconnu.',
    ...
    'An error occurred while changing order status #%d, or we were unable to send an email to the customer.' => 'Une erreur est survenue lors du changement d\'état de la commande (%d), ou il n\'est pas possible d\'envoyer l\'e-mail au client.',
  ...
  array (
    ...
    'The cart rule named "%2s" (ID %1s) used in this cart is not valid and has been withdrawn from cart' => 'La règle panier %2s (ID %1s) utilisée dans ce panier n\'est pas valide, elle a été supprimée du panier.',
...
Thanks for your patience.' => 'Notre boutique est en cours de mise à jour, nous revenons rapidement ! Merci pour votre patience.',
    ...
    'Add new shop' => 'Ajouter un magasin',
    'Multistore tree' => 'Arborescence multiboutiques',
    'Shop name' => 'Nom de la boutique',
    'Icon' => 'Icône',
    ...
    'Add new store' => 'Ajouter un magasin',
    'Stores' => 'Coordonnées & magasins',
  ...
  array (
    ...
    'If enabled, all messages will be saved in the "Customer Service" page under the "Customer" menu.' => 'Si cette option est activée, tous les messages seront enregistrés dans la page "Service client" du menu "Clients".',
    ...
    'When enabled, all the pages of your shop will be SSL-secured.' => 'Forcer toutes vous boutiques à utiliser SSL.',
  ...
  array (
    ...
    'Please go on <a href="{order_link}">{order_link}</a> to finalize the payment.' => 'Veuillez vous rendre sur <a href="{order_link}">{order_link}</a> afin de finaliser votre paiement.',
    ...
    'You can review your order and download your invoice from the <a href="{history_url}">"Order history"</a> section of your customer account by clicking <a href="{my_account_url}">"My account"</a> on our shop.' => 'Vous pouvez consulter le détail de votre commande via le lien <a href="{history_url}">"Historique de mes commandes"</a> dans la rubrique <a href="{my_account_url}">"Mon Compte"</a> sur notre site.',
    'If you have a guest account, you can follow your order via the <a href="{guest_tracking_url}?id_order={order_name}">"Guest Tracking"</a> section on our shop.' => 'Si vous avez un compte invité vous pouvez suivre votre commande via <a href="{guest_tracking_url}">ce lien</a>.',
    ...
    'You have <span><strong>{nbProducts}</strong></span> product(s) now available for download using the following link(s):' => 'Vous avez <span><strong>{nbProducts}</strong></span> produit(s) prêts à être téléchargés à l\'aide des liens suivants :',
    ...
    'Shipping' => 'Livraison',
    'Total Tax paid' => 'TVA totale payée',
    ...
    'There is a problem with your payment for <strong><span>{shop_name}</span></strong> order with the reference <strong><span>{order_name}</span></strong>. Please contact us at your earliest convenience.' => 'Un problème a été constaté pour le paiement de votre commande sur <strong><span>{shop_name}</span></strong> ayant pour référence <strong><span>{order_name}</span></strong>.',
    ...
    'Voucher created' => 'Nouveau bon de réduction',
    ...
    '<span><strong>Voucher code: {voucher_num}</strong></span> in the amount of <span><strong>{voucher_amount}</strong></span>' => '<span><strong>Code du bon de réduction : {voucher_num}</strong></span> pour un montant de <span><strong>{voucher_amount}</strong></span>',
    ...
    'You are advised to open the product&#039;s admin Product Page in order to replenish your inventory.' => 'Nous vous conseillons de vous rendre sur la page du produit dans le back-office afin de renouveler vos stocks.',
    ...
    'Your friend <span><strong>{firstname} {lastname}</strong></span> wants to refer you on <a href="{shop_url}">{shop_name}</a>!' => 'Votre ami <span><strong>{firstname} {lastname}</strong></span> souhaite vous parraîner sur la boutique <a href="{shop_url}">{shop_name}</a>!',
  ...
  array (
    ...
    'New voucher for your order %s' => 'Nouveau bon de réduction concernant votre commande %s',
  ...
  array (
    ...
    'Jewelry' => 'Bijouterie',
    'Lingerie and Adult' => 'Lingerie et produits pour adultes',
  ...
  array (
    ...
    'An error occured while trying to check your file permissions. Please adjust your permissions to allow PrestaShop to write a file in your root directory.' => 'Une erreur est survenue lors de la vérification des permissions des fichiers. Veuillez ajuster ces permissions afin que PrestaShop puisse enregistrer un fichier à la racine de votre site web.',
    ...
    'After creating the language, you can import the content of the language pack, which you can download under "Localization -- Translations.' => 'Après avoir créé la langue, vous pouvez importer le contenu du pack de langue, que vous pouvez télécharger depuis la page "Traductions" du menu "Localisation".',
    ...
    'product(s) matching the following rules:' => 'produit(s) correspondant aux règles suivantes :',
    ...
    'Download current file (%skb)' => 'Télécharger le fichier actuel (%s ko)',
  ...
  array (
    ...
    'Please also make sure you make a full manual backup of your files and database.' => 'Veuillez aussi vous assurez qu\'une sauvegarde manuelle complète de vos fichiers et de votre base de donnée est faite.',
    'Branch:' => 'Branche :',
    ...
    'Upgrade Complete!' => 'Mise à jour terminée !',
    'Upgrade complete, but warning notifications has been found.' => 'Mise à jour complète, mais des avertissements ont été trouvés.',
    ...
    'Please confirm that you want to preserve file options.' => 'Veuillez confirmer que vous souhaitez conserver les options du fichier.',
  ...
  array (
    ...
    'Banner Link' => 'Lien pour la bannière',
  ...
  array (
    'This payment method is not available.' => 'Cette méthode de paiement n\'est pas disponible.',
  ...
  array (
    ...
    'Show the price on the products in the block.' => 'Afficher le prix des produits dans le bloc.',
  ...
  array (
    ...
    'Net Profit' => 'Bénéfice net',
    'Dashboard' => 'Tableau de bord',
    'Sum of revenue (excl. tax) generated within the date range by orders considered validated.' => 'Somme des ventes (hors-taxe) générées dans l\'intervalle de dates pour les commandes considérées comme validées.',
    ...
    'Average Cart Value is a metric representing the value of an average order within the date range. It is calculated by dividing Sales by Orders.' => 'Le Panier Moyen est une mesure représentant la valeur de la commande moyenne dans l\'intervalle de dates. Elle est calculée en divisant le montant global des ventes par le nombre de commandes.',
    'Cart Value' => 'Panier Moyen',
    'Total number of visits within the date range. A visit is the period of time a user is actively engaged with your website.' => 'Nombre total de visites dans l\'intervalle de dates. Une visite est la période de temps durée laquelle un utilisateur est actif sur votre site.',
  ...
  array (
    ...
    'Customers\' country' => 'Pays des clients',
  ...
  array (
    ...
    'Filters:' => 'Filtres :',
    'Total filters: %s' => 'Nombre de filtres : %s',
    ...
    'Product condition filter' => 'Filtre par état des produits',
    ...
    'You must select at least one filter' => 'Vous devez sélectionner au moins un filtre',
    'You must select at least one category' => 'Vous devez sélectionner au moins une catégorie',
    'Warning! Your hosting provider is using the Suhosin patch for PHP, which limits the maximum number of fields allowed in a form:' => 'Attention, votre hébergement utilise le patch de sécurité Suhosin pour PHP, qui limite le nombre maximal de champs autorisés dans un formulaire :',
    'for suhosin.post.max_vars.' => 'pour suhosin.post.max_vars.',
    'for suhosin.request.max_vars.' => 'pour suhosin.request.max_vars.',
  ...
  array (
    ...
    'Invalid slide ID' => 'ID non valable pour la diapositive.',
    ...
    'Caption' => 'Légende',
    'Speed' => 'Vitesse',
    'The duration of the transition between two slides.' => 'Durée de la transition entre deux diapositives.',
...
[1]Pour les services :[/1] J\'accepte le lancement de la prestation de service et je reconnais perdre mon droit de révocation dès que la prestation est entièrement exécutée.',
  ...
  array (
    ...
    'Translate PrestaShop using the live translation module' => 'Traduisez PrestaShop grâce au module de traduction contextuelle',
  ...
  array (
    ...
    'Empty ALL "pages not found" notices for this period' => 'Vider toutes les mentions "pages introuvables" pour cet intervalle de temps',
  ...
  array (
    ...
    'Display the number of visitors who are currently watching this product.' => 'Afficher le nombre de personnes qui consultent la fiche produit à l\'instant présent.',
    ...
    'Display the last time the product has been ordered.' => 'Afficher la date de la dernière commande de ce produit.',
  ...
  array (
    ...
    'Best vouchers' => 'Meilleurs bons de réduction',
    'Adds a list of the best vouchers to the Stats dashboard.' => 'Ajoute une liste des bons de réduction les plus utilisés sur votre tableau de bord des statistiques.',
  ),
  ...
  array (
    ...
    'You should often consult this screen, as it allows you to quickly monitor your shop\'s sustainability. It also allows you to monitor multiple time periods.' => 'Vous devriez souvent consulter cet écran car il vous permet de rapidement contrôler la viabilité de votre boutique. Il vous permet également d\'observer plusieurs périodes de temps.',
  ...
  array (
    ...
    'Use a drop-down list' => 'Utiliser une liste déroulante',
    'Number of elements to display' => 'Nombre d\'éléments à afficher',
    'Only apply in plain-text mode' => 'S\'applique seulement dans le mode « texte plein »',
  ),
  ...
  array (
    ...
    'Manufacturers list' => 'Liste des marques',
  ...
  array (
    ...
    'List of products by brand %name%' => 'Liste des produits de la marque %name%',
  ...
  array (
    ...
    'Order history and details' => 'Historique de vos commandes',
